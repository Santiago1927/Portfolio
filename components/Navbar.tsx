        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <button
              ...
              className="ml-2 flex items-center space-x-2 px-3 py-2 rounded-lg bg-surface-light/50 dark:bg-surface-dark/50 hover:bg-accent-500/10 dark:hover:bg-accent-400/10 border border-gray-200/50 dark:border-gray-700/50 transition-all duration-200 hover:scale-105"
          ...
          <div className="md:hidden flex items-center space-x-2">
            <button
              ...
              aria-label="Cambiar idioma"
            >
              <span className="text-sm">{currentLocale === "es" ? "🇪🇸" : "🇬🇧"}</span>
            </button>
